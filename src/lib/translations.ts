...
export const translations = {
  ...
  home: {
    ...
    testimonialItems: [
      { text: { en: "Looks far more professional than our old site.", zh: "比我們的舊網站看起來專業多了。" }, name: { en: "James Mitchell", zh: "James Mitchell" }, company: { en: "Global Trade Co.", zh: "環球貿易公司" } },
      { text: { en: "The preview process made things easy and gave us confidence before moving forward.", zh: "預覽流程讓一切變得簡單，讓我們在繼續之前充滿信心。" }, name: { en: "Sarah Chen", zh: "Sarah Chen" }, company: { en: "Serenity Wellness", zh: "寧靜健康" } },
      { text: { en: "SwiftLift understood our business quickly and gave us two strong directions to compare. The final result feels much more modern and polished.", zh: "SwiftLift 快速了解了我們的業務，並提供了兩個強有力的方向供比較。最終結果感覺更加現代和精緻。" }, name: { en: "David Carter", zh: "David Carter" }, company: { en: "Carter & Associates", zh: "Carter & Associates" } },
      { text: { en: "Clean, fast, and exactly what we needed. Would recommend to any contractor.", zh: "簡潔、快速，正是我們所需。推薦給任何承包商。" }, name: { en: "Mike Torres", zh: "Mike Torres" }, company: { en: "BuildRight Construction", zh: "BuildRight 建築" } },
      { text: { en: "Our new site brings in clients weekly. The two-version approach made the decision easy.", zh: "我們的新網站每週都帶來客戶。兩個版本的方式讓決策變得容易。" }, name: { en: "Linda Park", zh: "Linda Park" }, company: { en: "Metro Wholesale", zh: "Metro 批發" } },
      { text: { en: "Fast turnaround. No hassle. The preview gave us a clear picture before committing.", zh: "快速交付。無麻煩。預覽在承諾前給了我們清晰的畫面。" }, name: { en: "Ryan Okafor", zh: "Ryan Okafor" }, company: { en: "Swift Logistics", zh: "Swift 物流" } },
    ],
