...
export const translations = {
  ...
  home: {
    ...
    testimonialItems: [
      { text: { en: "Our old website looked like it was built in 2010 and we were embarrassed to share it with potential clients. SwiftLift gave us two completely different directions to compare — one clean and professional, the other conversion-focused. We went with Version B and within the first month, we saw a noticeable increase in quote requests from the site.", zh: "我們的舊網站看起來像是2010年建的，我們都不好意思分享給潛在客戶。SwiftLift 給了我們兩個完全不同的方向進行比較 — 一個簡潔專業，另一個注重轉化。我們選擇了版本B，第一個月就明顯看到網站詢價量的增長。" }, name: { en: "James Mitchell", zh: "James Mitchell" }, company: { en: "Global Trade Co.", zh: "環球貿易公司" } },
      { text: { en: "I was nervous about redesigning our clinic website because I didn't know what direction to go. The two-preview approach removed all the guesswork. We compared both versions side by side and chose the one that felt right. Our patients have since told us the site is much easier to navigate and feels more trustworthy.", zh: "我對重新設計診所網站感到緊張，因為不知道該往什麼方向走。兩個預覽的方式消除了所有猜測。我們並排比較了兩個版本，選了感覺對的那個。我們的患者反映網站更容易瀏覽，更值得信賴。" }, name: { en: "Sarah Chen", zh: "Sarah Chen" }, company: { en: "Serenity Wellness", zh: "寧靜健康" } },
      { text: { en: "SwiftLift understood our business quickly and gave us two strong directions to compare. As a law firm, trust and credibility are everything online. The final result feels polished, modern, and far more professional than what we had before. New clients have mentioned the website as a deciding factor.", zh: "SwiftLift 快速了解了我們的業務，並提供了兩個強有力的方向供比較。作為律師事務所，網上的信任和信譽至關重要。最終結果感覺精緻、現代，比之前專業得多。新客戶提到網站是他們決策的關鍵因素。" }, name: { en: "David Carter", zh: "David Carter" }, company: { en: "Carter & Associates", zh: "Carter & Associates" } },
      { text: { en: "We'd been putting off a website update for over two years because we didn't want to deal with a long agency process. SwiftLift made it painless — we submitted our current site, got two clean previews back within days, picked one, and were live shortly after. Clean, fast, and exactly what a busy contractor needs.", zh: "我們拖了兩年多沒更新網站，因為不想經歷漫長的代理流程。SwiftLift 讓一切變得簡單 — 我們提交了現有網站，幾天內收到兩個簡潔的預覽，選了一個，很快就上線了。簡潔、快速，正是忙碌的承包商所需要的。" }, name: { en: "Mike Torres", zh: "Mike Torres" }, company: { en: "BuildRight Construction", zh: "BuildRight 建築" } },
      { text: { en: "The two-version approach was the reason we chose SwiftLift. Being able to compare Preview A and Preview B side by side made the decision so much easier. Our new site brings in client inquiries weekly now — something our old site never did. Highly recommend for any wholesale business.", zh: "兩個版本的方式是我們選擇 SwiftLift 的原因。能夠並排比較預覽A和預覽B讓決策變得容易得多。我們的新網站現在每週都帶來客戶詢盤 — 這是舊網站從未做到的。強烈推薦給任何批發業務。" }, name: { en: "Linda Park", zh: "Linda Park" }, company: { en: "Metro Wholesale", zh: "Metro 批發" } },
      { text: { en: "We needed a website that reflected how fast our company is growing, but our old site felt static and outdated. SwiftLift delivered two preview directions quickly, let us compare, and the final version looks sharp and professional. The turnaround was faster than any agency we've worked with before.", zh: "我們需要一個能反映公司快速成長的網站，但舊網站感覺靜止且過時。SwiftLift 快速提供了兩個預覽方向，讓我們比較，最終版本看起來銳利且專業。交付速度比我們合作過的任何代理商都快。" }, name: { en: "Ryan Okafor", zh: "Ryan Okafor" }, company: { en: "Swift Logistics", zh: "Swift 物流" } },
    ],
