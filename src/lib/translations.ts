...
export const translations = {
  ...
  home: {
    ...
    heroSub: {
      en: "We build two previews first.\nYou choose. We launch in 3 days.",
      zh: "我們先建兩個預覽。\n您選擇。我們3天內上線。",
    },
    heroBullets: [
      { en: "No upfront payment", zh: "無需預付" },
      { en: "Fixed pricing", zh: "固定價格" },
      { en: "3-day launch", zh: "3天上線" },
    ],
    ...
    formSubmit: { en: "Generate My FREE Previews", zh: "生成我的免費預覽" },
    ...
    optional: { en: "(Optional)", zh: "（選填）" },
    howItWorks: { en: "How SwiftLift Works", zh: "SwiftLift 如何運作" },
    howItWorksSub: { en: "A simple, predictable process.", zh: "簡單、可預測的流程。" },
    steps: [
      { title: { en: "We Build Two Previews", zh: "我們建立兩個預覽" }, desc: { en: "We design two modern website previews tailored to your business.", zh: "我們為您的業務量身設計兩個現代化網站預覽。" } },
      { title: { en: "You Choose & Approve", zh: "您選擇並批准" }, desc: { en: "Pick the direction you prefer. Request small refinements if needed.", zh: "選擇您喜歡的方向。如需微調可提出要求。" } },
      { title: { en: "Launch in 3 Days", zh: "3天內上線" }, desc: { en: "Once approved, your website goes live within 3 days.", zh: "批准後，您的網站將在3天內正式上線。" } },
    ],
    portfolioTitle: { en: "Real Businesses. Built with SwiftLift.", zh: "真實企業。SwiftLift 打造。" },
    portfolioSub: { en: "Before and after — see the difference.", zh: "前後對比 — 看看差異。" },
    portfolioItems: [
      ...
      { name: { en: "Carter & Associates", zh: "Carter & Associates" }, desc: { en: "Rebuilt credibility with a clean professional law firm site.", zh: "以簡潔專業的律師事務所網站重建信譽。" } },
      { name: { en: "BuildRight Construction", zh: "BuildRight 建築" }, desc: { en: "Showcased past projects with a conversion-focused layout.", zh: "以轉化導向的版面展示過往項目。" } },
      { name: { en: "Metro Wholesale", zh: "Metro 批發" }, desc: { en: "Organized product categories into a clear distributor site.", zh: "將產品類別整理為清晰的經銷商網站。" } },
      { name: { en: "Swift Logistics", zh: "Swift 物流" }, desc: { en: "Streamlined service pages for a fast-growing logistics company.", zh: "為快速成長的物流公司精簡服務頁面。" } },
    ],
    testimonialItems: [
      { text: { en: "SwiftLift delivered a stunning website in just 3 days. The preview process gave us total confidence before paying.", zh: "SwiftLift 僅用3天就交付了令人驚豔的網站。預覽流程讓我們在付款前充滿信心。" }, name: { en: "James Mitchell", zh: "James Mitchell" }, company: { en: "Global Trade Co.", zh: "環球貿易公司" } },
      { text: { en: "We went from an outdated site to a modern booking platform. The process was seamless and stress-free.", zh: "我們從過時的網站轉變為現代化預約平台。整個過程流暢無壓力。" }, name: { en: "Sarah Chen", zh: "Sarah Chen" }, company: { en: "Serenity Wellness", zh: "寧靜健康" } },
      { text: { en: "Professional, fast, and exactly what we needed. The two-preview approach made decision-making easy.", zh: "專業、快速，正是我們所需。兩個預覽方案讓決策變得簡單。" }, name: { en: "David Carter", zh: "David Carter" }, company: { en: "Carter & Associates", zh: "Carter & Associates" } },
      { text: { en: "BuildRight's online presence finally matches the quality of our work. Highly recommend SwiftLift.", zh: "BuildRight 的線上形象終於與我們的工作品質相匹配。強烈推薦 SwiftLift。" }, name: { en: "Mike Torres", zh: "Mike Torres" }, company: { en: "BuildRight Construction", zh: "BuildRight 建築" } },
      { text: { en: "Our distributor site is now clear, organized, and brings in new clients weekly.", zh: "我們的經銷商網站現在清晰、有條理，每週都能帶來新客戶。" }, name: { en: "Linda Park", zh: "Linda Park" }, company: { en: "Metro Wholesale", zh: "Metro 批發" } },
      { text: { en: "Fast turnaround and clean design. SwiftLift understood our logistics business perfectly.", zh: "快速交付和簡潔設計。SwiftLift 完美理解了我們的物流業務。" }, name: { en: "Ryan Okafor", zh: "Ryan Okafor" }, company: { en: "Swift Logistics", zh: "Swift 物流" } },
    ],
    viewLiveWebsite: { en: "View Live Website →", zh: "查看線上網站 →" },
    builtWith: { en: "Built with the SwiftLift System.", zh: "使用 SwiftLift 系統構建。" },
    after: { en: "After", zh: "之後" },
    before: { en: "Before", zh: "之前" },
    pricingTitle: { en: "Simple, Transparent Pricing", zh: "簡單、透明的價格" },
    pricingSub: { en: "No credit card required to see your previews.", zh: "查看預覽無需信用卡。" },
    mostPopular: { en: "Most Popular", zh: "最受歡迎" },
    plans: [
      { name: { en: "Launch", zh: "啟動版" }, features: { en: ["1–2 Pages", "Clean Modern Design", "Mobile Responsive", "1 Free Revision", "Launch in 3 Days"], zh: ["1–2 頁", "簡潔現代設計", "移動端響應式", "1次免費修改", "3天上線"] }, cta: { en: "Claim My FREE Previews", zh: "獲取免費預覽" } },
      { name: { en: "Growth", zh: "成長版" }, features: { en: ["3–7 Pages", "Structured Layout", "Mobile Responsive", "1 Free Revision", "Launch in 3 Days"], zh: ["3–7 頁", "結構化版面", "移動端響應式", "1次免費修改", "3天上線"] }, cta: { en: "Claim My FREE Previews", zh: "獲取免費預覽" } },
      { name: { en: "Conversion Architecture", zh: "轉化架構" }, features: { en: ["Up to 20 Pages", "Full Planning Phase", "Unlimited Revisions (Production Only)", "Funnel-Based Page Structure"], zh: ["最多20頁", "完整規劃階段", "無限修改（僅限生產階段）", "漏斗式頁面結構"] }, cta: { en: "Claim My FREE Previews", zh: "獲取免費預覽" } },
    ],
    ...
    ctaTitle: { en: "Ready to See Your New Website?", zh: "準備好看看您的新網站嗎？" },
    ctaSub: { en: "Fill out the form. Get two free previews. No obligation.", zh: "填寫表格。獲得兩個免費預覽。無任何義務。" },
  },
} as const;
