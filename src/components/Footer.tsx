...
import { Instagram, ShieldCheck, Mail } from "lucide-react";
...
const Footer = () => {
  ...
  return (
    <footer className="py-12 md:py-16 pb-28 md:pb-16" style={{ background: "hsl(var(--footer-bg))" }}>
        ...
        <div className="hidden md:grid grid-cols-[2fr_0.5fr_1fr_1fr_1fr_1.2fr] gap-8">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2" aria-label="Footer navigation">
              {navItems.map((item) => (
                <a key={item.href} href={item.href} className="text-sm text-blue-200/70 hover:text-white transition-colors">
                  {item.label}
                </a>
              ))}
            </nav>
          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              <a href="https://www.instagram.com/blulumadesign/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-blue-200/70 hover:text-white transition-colors">
                <Instagram size={18} />
              </a>
            </div>
          </div>

          {/* Column 4: Satisfaction Guarantee */}
